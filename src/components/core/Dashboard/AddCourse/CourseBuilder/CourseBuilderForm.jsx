...
const CourseBuilderForm = () => {
  ...
  return (
    <div className="space-y-8 text-white rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6">
      <p className='flex justify-start text-2xl'>Course Builder</p>
